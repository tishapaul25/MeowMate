<section class="w-full py-12 md:py-24 lg:py-32 bg-green-50">
    <div class="container px-4 md:px-6 mx-auto max-w-7xl">
        <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div
                class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-green-600 text-white">
                For Providers
            </div>
                ...
                <ul class="grid gap-6">
                    <li class="flex items-start gap-4">
                        ...
                        <div class="grid gap-1">
                            <h3 class="text-xl font-bold text-green-900">Apply & Get Certified</h3>
                            <p class="text-green-700">Complete our certification process and meet our quality standards.
                            </p>
                        </div>
                    </li>
                    <li class="flex items-start gap-4">
                        ...
                        <div class="grid gap-1">
                            <h3 class="text-xl font-bold text-green-900">Set Your Schedule</h3>
                            <p class="text-green-700">Choose your availability and pricing for cat boarding services.
                            </p>
                        </div>
                    </li>
                    <li class="flex items-start gap-4">
                        ...
                        <div class="grid gap-1">
                            <h3 class="text-xl font-bold text-green-900">Start Earning</h3>
                            <p class="text-green-700">Welcome cats into your home and earn money doing what you love.
                            </p>
                        </div>
                    </li>
                </ul>
                <button
                    class="bg-green-600 hover:bg-green-700 text-white w-fit px-6 py-2 rounded-md font-medium transition-colors">
                    Become a Provider
                </button>
            </div>
